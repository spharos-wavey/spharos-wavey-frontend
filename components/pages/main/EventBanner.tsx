...
export default function EventBanner() {
  ...
  return (
    <div className={isActive ? `${style.bannerWrap} ${style.active}`: style.bannerWrap} onClick={()=>setIsActive(!isActive)}>
      {
        bannerData && 
        <>
          <div className={style.bannerContents}>
            <div className={style.bannerLeft}>
              ...
              <div className={style.brandImage}>
                <Image src={bannerData.carBrandImage} width={200} height={200} alt={bannerData.carBrand} priority/>
              </div>
            </div>
